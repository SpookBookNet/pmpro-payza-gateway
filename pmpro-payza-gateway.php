<?php
	...
	add_action('init', array('PMProGateway_payza', 'init'));

	/**
	 * PMProGateway_gatewayname Class
	 *
	 * Handles payza integration.
	 *
	 */
	class PMProGateway_payza extends PMProGateway
	{
		...
		/**
		 * Make sure payza is in the gateways list
		 *
		 * @since 1.8
		 */
		static function pmpro_gateways($gateways)
		{
			if(empty($gateways['payza']))
				$gateways['payza'] = __('payza', 'pmpro');

			return $gateways;
		}

		/**
		 * Get a list of payment options that the payza gateway needs/supports.
		 *
		 * @since 1.8
		 */
		...
		/**
		 * Display fields for payza options.
		 *
		 * @since 1.8
		 */
